                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="admin_artikel.php"><i class="fa fa-bullhorn fa-fw"></i> Artikel</a>

                                </li>
                                <li>
                                    <a href="admin_media.php"><i class="fa fa-file-sound-o fa-fw"></i> Media</a>
                                    
                                </li>
                                <li>
                                    <a href="admin_perkembangan.php"><i class="fa fa-heartbeat fa-fw"></i> Perkembangan</a>
                                    
                                </li>
                                <li>
                                    <a href="admin_mpasi.php"><i class="fa fa-lightbulb-o fa-fw"></i> Resep Mpasi</a>
